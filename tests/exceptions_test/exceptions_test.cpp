...
suite starter = [] {
   ...
   "json_schema"_test = [] {
      ...
      expect(
         schema ==
         R"({"type":"object","properties":{"arr":{"type":"array","items":{"type":"integer","minimum":0,"maximum":18446744073709551615},"maxItems":3},"d":{"type":"number","minimum":-1.7976931348623157E308,"maximum":1.7976931348623157E308},"hello":{"type":"string"},"i":{"type":"integer","minimum":-2147483648,"maximum":2147483647}},"additionalProperties":false,"title":"my_struct"})")
         << schema;
   };
