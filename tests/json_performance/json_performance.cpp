...
template<> struct
glz::meta<test_generator<test_struct>> {
   using T         = test_generator<test_struct>;
   static constexpr auto value = object("a", &T::a, "b", &T::b, "c", &T::c, "d", &T::d, "e", &T::e, "f", &T::f, "g",
      &T::g, "h", &T::h, "i", &T::i, "j", &T::j, "k", &T::k, "l", &T::l, "m", &T::m, "n", &T::n, "o",
      &T::o, "p", &T::p, "q", &T::q, "r", &T::r, "s", &T::s, "t", &T::t, "u", &T::u, "v", &T::v, "w",
      &T::w, "x", &T::x, "y", &T::y, "z", &T::z);
};
...
struct glz::meta<abc_test<test_struct>> {
   ...
   static constexpr auto value = glz::object(&T::a, &T::b, &T::c, &T::d, &T::e, &T::f, &T::g, &T::h,
