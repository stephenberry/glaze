...
struct glz::meta<Thing>
{
   ...
   static constexpr auto value = object(
      ...
      "i", [](auto&& v) -> auto& { return v.i; }, glz::schema{.minimum = 2, .required = required}, //
