...
suite json_schema = [] {
   "json schema"_test = [] {
      ...
      expect(
         schema ==
         R"({"type":"object","properties":{"array":{"$ref":"#/$defs/std::array<std::string,4>"},"b":{"type":"boolean"},"c":{"type":"string"},"color":{"$ref":"#/$defs/Color"},"d":{"$ref":"#/$defs/double"},"deque":{"$ref":"#/$defs/std::deque<double>"},"i":{"$ref":"#/$defs/int32_t"},"list":{"$ref":"#/$defs/std::list<int32_t>"},"map":{"$ref":"#/$defs/std::map<std::string,int32_t>"},"mapi":{"$ref":"#/$defs/std::map<int32_t,double>"},"optional":{"$ref":"#/$defs/std::optional<V3>"},"sptr":{"$ref":"#/$defs/std::shared_ptr<sub_thing>"},"thing":{"$ref":"#/$defs/sub_thing"},"thing2array":{"$ref":"#/$defs/std::array<sub_thing2,1>"},"thing_ptr":{"$ref":"#/$defs/sub_thing*"},"v":{"$ref":"#/$defs/std::variant<var1_t,var2_t>"},"vb":{"$ref":"#/$defs/std::vector<bool>"},"vec3":{"$ref":"#/$defs/V3"},"vector":{"$ref":"#/$defs/std::vector<V3>"}},"additionalProperties":false,"$defs":{"Color":{"type":"string","oneOf":[{"title":"Red","const":"Red"},{"title":"Green","const":"Green"},{"title":"Blue","const":"Blue"}]},"V3":{"type":"array","prefixItems":[{"type":"number","minimum":-1.7976931348623157E308,"maximum":1.7976931348623157E308},{"type":"number","minimum":-1.7976931348623157E308,"maximum":1.7976931348623157E308},{"type":"number","minimum":-1.7976931348623157E308,"maximum":1.7976931348623157E308}],"items":false,"maxItems":3},"double":{"type":"number","minimum":-1.7976931348623157E308,"maximum":1.7976931348623157E308},"float":{"type":"number","minimum":-3.4028234663852886E38,"maximum":3.4028234663852886E38},"int32_t":{"type":"integer","minimum":-2147483648,"maximum":2147483647},"std::array<std::string,4>":{"type":"array","items":{"type":"string"},"maxItems":4},"std::array<sub_thing2,1>":{"type":"array","items":{"$ref":"#/$defs/sub_thing2"},"maxItems":1},"std::deque<double>":{"type":"array","items":{"type":"number","minimum":-1.7976931348623157E308,"maximum":1.7976931348623157E308}},"std::list<int32_t>":{"type":"array","items":{"type":"integer","minimum":-2147483648,"maximum":2147483647}},"std::map<int32_t,double>":{"type":"object","additionalProperties":{"type":"number","minimum":-1.7976931348623157E308,"maximum":1.7976931348623157E308}},"std::map<std::string,int32_t>":{"type":"object","additionalProperties":{"type":"integer","minimum":-2147483648,"maximum":2147483647}},"std::optional<V3>":{"type":["array","null"],"prefixItems":[{"type":"number","minimum":-1.7976931348623157E308,"maximum":1.7976931348623157E308},{"type":"number","minimum":-1.7976931348623157E308,"maximum":1.7976931348623157E308},{"type":"number","minimum":-1.7976931348623157E308,"maximum":1.7976931348623157E308}],"items":false,"maxItems":3},"std::shared_ptr<sub_thing>":{"type":["object","null"],"properties":{"a":{"$ref":"#/$defs/double"},"b":{"type":"string"}},"additionalProperties":false},"std::variant<var1_t,var2_t>":{"type":"object","oneOf":[{"$ref":"#/$defs/var1_t","title":"var1_t"},{"$ref":"#/$defs/var2_t","title":"var2_t"}]},"std::vector<V3>":{"type":"array","items":{"$ref":"#/$defs/V3"}},"std::vector<bool>":{"type":"array","items":{"type":"boolean"}},"sub_thing":{"type":"object","properties":{"a":{"$ref":"#/$defs/double"},"b":{"type":"string"}},"additionalProperties":false},"sub_thing*":{"type":["object","null"],"properties":{"a":{"$ref":"#/$defs/double"},"b":{"type":"string"}},"additionalProperties":false},"sub_thing2":{"type":"object","properties":{"a":{"$ref":"#/$defs/double"},"b":{"type":"string"},"c":{"$ref":"#/$defs/double"},"d":{"$ref":"#/$defs/double"},"e":{"$ref":"#/$defs/double"},"f":{"$ref":"#/$defs/float"},"g":{"$ref":"#/$defs/double"},"h":{"$ref":"#/$defs/double"}},"additionalProperties":false},"var1_t":{"type":"object","properties":{"x":{"$ref":"#/$defs/double"}},"additionalProperties":false},"var2_t":{"type":"object","properties":{"y":{"$ref":"#/$defs/double"}},"additionalProperties":false}},"examples":[{"thing":{},"i":42}],"required":["thing","i"],"title":"Thing"})")
         << schema;
   };
};
