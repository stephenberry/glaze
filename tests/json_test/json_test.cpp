...
suite json_schema = [] {
   "json schema"_test = [] {
      ...
      expect(
         schema ==
         R"({"type":["object"],"properties":{"array":{"$ref":"#/$defs/std::array<std::string,4>","examples":null},"b":{"$ref":"#/$defs/bool","examples":null},"c":{"$ref":"#/$defs/char","examples":null},"color":{"$ref":"#/$defs/Color","examples":null},"d":{"$ref":"#/$defs/double","description":"double is the best type","examples":null},"deque":{"$ref":"#/$defs/std::deque<double>","examples":null},"i":{"$ref":"#/$defs/int32_t","examples":null,"minimum":2},"list":{"$ref":"#/$defs/std::list<int32_t>","examples":null},"map":{"$ref":"#/$defs/std::map<std::string,int32_t>","examples":null},"mapi":{"$ref":"#/$defs/std::map<int32_t,double>","examples":null},"optional":{"$ref":"#/$defs/std::optional<V3>","examples":null},"sptr":{"$ref":"#/$defs/std::shared_ptr<sub_thing>","examples":null},"thing":{"$ref":"#/$defs/sub_thing","examples":null},"thing2array":{"$ref":"#/$defs/std::array<sub_thing2,1>","examples":null},"thing_ptr":{"$ref":"#/$defs/sub_thing*","examples":null},"v":{"$ref":"#/$defs/std::variant<var1_t,var2_t>","examples":null},"vb":{"$ref":"#/$defs/std::vector<bool>","examples":null},"vec3":{"$ref":"#/$defs/V3","examples":null},"vector":{"$ref":"#/$defs/std::vector<V3>","examples":null}},"additionalProperties":false,"$defs":{"Color":{"type":["string"],"oneOf":[{"const":"Red","examples":null},{"const":"Green","examples":null},{"const":"Blue","examples":null}],"examples":null},"V3":{"type":["array"],"examples":null},"bool":{"type":["boolean"],"examples":null},"char":{"type":["string"],"examples":null},"double":{"type":["number"],"examples":null},"float":{"type":["number"],"examples":null},"int32_t":{"type":["integer"],"examples":null},"std::array<std::string,4>":{"type":["array"],"items":{"$ref":"#/$defs/std::string","examples":null},"examples":null},"std::array<sub_thing2,1>":{"type":["array"],"items":{"$ref":"#/$defs/sub_thing2","examples":null},"examples":null},"std::deque<double>":{"type":["array"],"items":{"$ref":"#/$defs/double","examples":null},"examples":null},"std::list<int32_t>":{"type":["array"],"items":{"$ref":"#/$defs/int32_t","examples":null},"examples":null},"std::map<int32_t,double>":{"type":["object"],"additionalProperties":{"$ref":"#/$defs/double","examples":null},"examples":null},"std::map<std::string,int32_t>":{"type":["object"],"additionalProperties":{"$ref":"#/$defs/int32_t","examples":null},"examples":null},"std::optional<V3>":{"type":["array","null"],"examples":null},"std::shared_ptr<sub_thing>":{"type":["object","null"],"properties":{"a":{"$ref":"#/$defs/double","description":"Test comment 1","examples":null},"b":{"$ref":"#/$defs/std::string","description":"Test comment 2","examples":null}},"additionalProperties":false,"examples":null},"std::string":{"type":["string"],"examples":null},"std::variant<var1_t,var2_t>":{"type":["number","string","boolean","object","array","null"],"oneOf":[{"type":["object"],"properties":{"x":{"$ref":"#/$defs/double","examples":null}},"additionalProperties":false,"examples":null},{"type":["object"],"properties":{"y":{"$ref":"#/$defs/double","examples":null}},"additionalProperties":false,"examples":null}],"examples":null},"std::vector<V3>":{"type":["array"],"items":{"$ref":"#/$defs/V3","examples":null},"examples":null},"std::vector<bool>":{"type":["array"],"items":{"$ref":"#/$defs/bool","examples":null},"examples":null},"sub_thing":{"type":["object"],"properties":{"a":{"$ref":"#/$defs/double","description":"Test comment 1","examples":null},"b":{"$ref":"#/$defs/std::string","description":"Test comment 2","examples":null}},"additionalProperties":false,"examples":null},"sub_thing*":{"type":["object","null"],"properties":{"a":{"$ref":"#/$defs/double","description":"Test comment 1","examples":null},"b":{"$ref":"#/$defs/std::string","description":"Test comment 2","examples":null}},"additionalProperties":false,"examples":null},"sub_thing2":{"type":["object"],"properties":{"a":{"$ref":"#/$defs/double","description":"Test comment 1","examples":null},"b":{"$ref":"#/$defs/std::string","description":"Test comment 2","examples":null},"c":{"$ref":"#/$defs/double","examples":null},"d":{"$ref":"#/$defs/double","examples":null},"e":{"$ref":"#/$defs/double","examples":null},"f":{"$ref":"#/$defs/float","examples":null},"g":{"$ref":"#/$defs/double","examples":null},"h":{"$ref":"#/$defs/double","examples":null}},"additionalProperties":false,"examples":null}},"required":["thing","i"],"examples":[{"thing":{},"i":42}]})") << schema;
   };
};
