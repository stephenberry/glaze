...
suite tagged_variant_tests = [] {
   ...
   "shared_ptr variant schema"_test = [] {
      ...
      // Accept both forms for the title
      auto expected_qualified =
         R"({"type":["object","null"],"oneOf":[{"type":"object","properties":{"data":{"type":"object","additionalProperties":{"type":"integer","minimum":-2147483648,"maximum":2147483647}},"type":{"const":"put_action"}},"additionalProperties":false,"required":["type"],"title":"put_action"},{"type":"object","properties":{"data":{"type":"string"},"type":{"const":"delete_action"}},"additionalProperties":false,"required":["type"],"title":"delete_action"},{"type":"null","title":"std::monostate","const":null}],"title":"std::shared_ptr<std::variant<put_action, delete_action, std::monostate>>"})";
#if GLZ_REFLECTION26
      auto expected_unqualified =
         R"({"type":["object","null"],"oneOf":[{"type":"object","properties":{"data":{"type":"object","additionalProperties":{"type":"integer","minimum":-2147483648,"maximum":2147483647}},"type":{"const":"put_action"}},"additionalProperties":false,"required":["type"],"title":"put_action"},{"type":"object","properties":{"data":{"type":"string"},"type":{"const":"delete_action"}},"additionalProperties":false,"required":["type"],"title":"delete_action"},{"type":"null","title":"std::monostate","const":null}],"title":"std::shared_ptr<variant<put_action, delete_action, monostate>>"})";
