...
struct glz::meta<VariantTestStruct>
{
   ...
   static constexpr auto value = glz::object("id", &T::id, "name", &T::name, "value", &T::value);
};
...
struct glz::meta<AnotherStruct>
{
   ...
   static constexpr auto value = glz::object("numbers", &T::numbers, "description", &T::description);
};
...
struct StructWithVariant
{
   ...
   // Methods
   int get_variant_index() const { return static_cast<int>(basic_variant.index()); }

   void set_to_int(int value) { basic_variant = value; }

   void set_to_string(const std::string& value) { basic_variant = value; }

   void set_to_double(double value) { basic_variant = value; }
};
...
struct glz::meta<StructWithVariant>
{
   ...
   static constexpr auto value =
      glz::object("basic_variant", &T::basic_variant, "struct_variant", &T::struct_variant, "optional_variant",
                  &T::optional_variant, "get_variant_index", &T::get_variant_index, "set_to_int", &T::set_to_int,
                  "set_to_string", &T::set_to_string, "set_to_double", &T::set_to_double);
};

// Complex nested variant type
using ComplexVariant = std::variant<int, double, std::string, std::vector<int>, std::unordered_map<std::string, double>,
                                    VariantTestStruct, std::optional<int>, std::complex<float>>;
...
int main()
{
   ...
   "variant type descriptor for complex types"_test = [] {
      using ComplexVar = std::variant<std::vector<int>, std::unordered_map<std::string, double>,
                                      std::optional<std::string>, std::complex<float>>;
   ...
   "edge cases and error conditions"_test = [] {
      ...
      using LargeVariant = std::variant<int, double, float, bool, char, int8_t, int16_t, int32_t, int64_t, uint8_t,
