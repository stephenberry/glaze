...
// Combines: test_cross_library_structures.cpp, test_structure_validation.cpp, test_json_across_libraries.cpp, test_json_serialization.cpp
#include "ut/ut.hpp"
#include <iostream>
#include <filesystem>
#include <string>
...
PersonData sample_person{
    "Alice Johnson", 28, 165.5, false, {"reading", "hiking", "programming"}, "alice@example.com"
};
...
public:
    ...
    explicit ComplexStructuresPlugin(const std::string& plugin_path) {
        ...
        create_person = reinterpret_cast<void*(*)(uint32_t, const char*, const char*, int)>(GET_SYMBOL(handle_, "create_person"));
        delete_person = reinterpret_cast<void(*)(void*)>(GET_SYMBOL(handle_, "delete_person"));
        create_project = reinterpret_cast<void*(*)(uint32_t, const char*, const char*)>(GET_SYMBOL(handle_, "create_project"));
        ...
        get_person_home_address = reinterpret_cast<const char*(*)(void*)>(GET_SYMBOL(handle_, "get_person_home_address"));
        add_person_skill = reinterpret_cast<void(*)(void*, const char*, double)>(GET_SYMBOL(handle_, "add_person_skill"));
        get_person_skill_rating = reinterpret_cast<double(*)(void*, const char*)>(GET_SYMBOL(handle_, "get_person_skill_rating"));
        
        get_company_name = reinterpret_cast<const char*(*)(void*)>(GET_SYMBOL(handle_, "get_company_name"));
        get_company_headquarters_address = reinterpret_cast<const char*(*)(void*)>(GET_SYMBOL(handle_, "get_company_headquarters_address"));
        get_company_office_count = reinterpret_cast<size_t(*)(void*)>(GET_SYMBOL(handle_, "get_company_office_count"));
        add_employee_to_company = reinterpret_cast<void(*)(void*, void*)>(GET_SYMBOL(handle_, "add_employee_to_company"));
        get_company_employee_count = reinterpret_cast<size_t(*)(void*)>(GET_SYMBOL(handle_, "get_company_employee_count"));
        
        get_project_name = reinterpret_cast<const char*(*)(void*)>(GET_SYMBOL(handle_, "get_project_name"));
        get_project_milestone_count = reinterpret_cast<size_t(*)(void*)>(GET_SYMBOL(handle_, "get_project_milestone_count"));
        get_project_completion_percentage = reinterpret_cast<double(*)(void*)>(GET_SYMBOL(handle_, "get_project_completion_percentage"));
        complete_project_milestone = reinterpret_cast<void(*)(void*, size_t, const char*)>(GET_SYMBOL(handle_, "complete_project_milestone"));
        ...
        if (!create_company || !create_person || !create_project ||
            !get_person_full_name || !get_company_name || !get_project_name ||
...
int main() {
    ...
    "cross-library data extraction for JSON"_test = [] {
        ...
        auto create_person = reinterpret_cast<void*(*)(uint32_t, const char*, const char*, int)>(
            GET_SYMBOL(handle, "create_person"));
        auto delete_person = reinterpret_cast<void(*)(void*)>(
            GET_SYMBOL(handle, "delete_person"));
        auto get_person_full_name = reinterpret_cast<const char*(*)(void*)>(
            GET_SYMBOL(handle, "get_person_full_name"));
        auto get_person_email = reinterpret_cast<const char*(*)(void*)>(
            GET_SYMBOL(handle, "get_person_email"));
        auto get_person_home_address = reinterpret_cast<const char*(*)(void*)>(
            GET_SYMBOL(handle, "get_person_home_address"));
        auto add_person_skill = reinterpret_cast<void(*)(void*, const char*, double)>(
            GET_SYMBOL(handle, "add_person_skill"));
        auto get_person_skill_rating = reinterpret_cast<double(*)(void*, const char*)>(
            GET_SYMBOL(handle, "get_person_skill_rating"));
