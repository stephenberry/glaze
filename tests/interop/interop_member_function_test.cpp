...
struct glz::meta<Calculator> {
    ...
    static constexpr auto value = object(
        "value", &T::value,
        "last_operation", &T::last_operation,
        "add", &T::add,
        "multiply_int", &T::multiply_int,
        "describe", &T::describe,
        "reset", &T::reset,
        "generate_sequence", &T::generate_sequence,
        "safe_divide", &T::safe_divide,
        "polynomial", &T::polynomial,
        "is_positive", &T::is_positive,
        "compute_async", &T::compute_async
    );
};
...
int main() {
    ...
    "function invocation with return value"_test = [] {
        ...
        // Call function
        void* ret = glz_call_member_function_with_type(
            &calc, "Calculator", add_member, args, &result
        );
    ...
    "void function invocation"_test = [] {
        ...
        glz_call_member_function_with_type(
            &calc, "Calculator", reset_member, nullptr, nullptr
        );
    ...
    "const function invocation"_test = [] {
        ...
        bool result;
        glz_call_member_function_with_type(
            &calc, "Calculator", is_positive_member, nullptr, &result
        );
    ...
    "vector return type"_test = [] {
        ...
        glz_call_member_function_with_type(
            &calc, "Calculator", gen_member, args, &result
        );
    ...
    "optional return type"_test = [] {
        ...
        glz_call_member_function_with_type(
            &calc, "Calculator", divide_member, args, &result
        );
    ...
    "multiple parameters"_test = [] {
        ...
        double result;
        glz_call_member_function_with_type(
            &calc, "Calculator", poly_member, args, &result
        );
    ...
    "async function return"_test = [] {
        ...
        void* future_wrapper = glz_call_member_function_with_type(
            &calc, "Calculator", async_member, args, nullptr
        );
        ...
        // Get result
        auto* result_ptr = glz_shared_future_get(future_wrapper, 
            func_desc->data.function.return_type->data.shared_future.value_type);
        ...
        glz_shared_future_destroy(future_wrapper, 
            func_desc->data.function.return_type->data.shared_future.value_type);
    ...
    "error handling"_test = [] {
        ...
        auto* ret = glz_call_member_function_with_type(
            nullptr, "Calculator", add_member, args, &result
        );
        expect(ret == nullptr);
        
        // Test null member
        ret = glz_call_member_function_with_type(
            &calc, "Calculator", nullptr, args, &result
        );
        expect(ret == nullptr);
        
        // Test wrong type name
        ret = glz_call_member_function_with_type(
            &calc, "WrongType", add_member, args, &result
        );
        expect(ret == nullptr);
