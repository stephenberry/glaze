...
struct glz::meta<OptionalTestStruct>
{
   ...
   static constexpr auto value =
      glz::object("opt_bool", &T::opt_bool, "opt_i8", &T::opt_i8, "opt_i16", &T::opt_i16, "opt_i32", &T::opt_i32,
                  "opt_i64", &T::opt_i64, "opt_u8", &T::opt_u8, "opt_u16", &T::opt_u16, "opt_u32", &T::opt_u32,
                  "opt_u64", &T::opt_u64, "opt_f32", &T::opt_f32, "opt_f64", &T::opt_f64, "opt_string", &T::opt_string,
                  "opt_vector", &T::opt_vector, "opt_map", &T::opt_map, "opt_complex_f", &T::opt_complex_f,
                  "opt_complex_d", &T::opt_complex_d, "get_opt_value", &T::get_opt_value, "set_opt_value",
                  &T::set_opt_value, "get_opt_string", &T::get_opt_string, "set_opt_string", &T::set_opt_string);
};
...
struct glz::meta<NestedOptionalStruct>
{
   ...
   static constexpr auto value = glz::object("nested_optional", &T::nested_optional, "double_optional",
                                             &T::double_optional, "vector_of_optionals", &T::vector_of_optionals);
};
...
int main()
{
   ...
   "optional map type"_test = [] {
      ...
      test_obj.opt_map = std::unordered_map<std::string, int>{{"one", 1}, {"two", 2}, {"three", 3}};
      expect(test_obj.opt_map.has_value());
   ...
   "nested optional struct"_test = [] {
      ...
      // Vector of optionals
      test_obj.vector_of_optionals =
         std::vector<std::optional<std::string>>{"first", std::nullopt, "third", std::nullopt, "fifth"};
