...
struct glz::meta<SensorData> {
    ...
    static constexpr auto value = object(
        ...
        "location", &T::location,
        "notes", &T::notes,
        "get_average_measurement", &T::get_average_measurement,
        "add_measurement", &T::add_measurement,
        "get_info", &T::get_info,
...
SensorData global_sensor{
    "Temperature Sensor", 42, 25.5f, true, {20.0f, 21.5f, 23.0f, 22.0f},
    {37.7749, -122.4194, 52.0f, "San Francisco"}, "Test sensor"
};
