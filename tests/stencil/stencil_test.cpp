...
suite container_iteration_tests = [] {
   ...
   "container_with_multiple_properties"_test = [] {
      ...
      TodoList list{
         "Tasks",
         {{"Buy milk", false, "normal", "shopping", 1, 0},
            {"Call mom", true, "high", "personal", 2, 1}},
         true,
         2
      };
   ...
   "mixed_boolean_and_container_sections"_test = [] {
      ...
      TodoList list_with_items{
         "Active List",
         {{"Task 1", true, "high", "work", 1, 0}, {"Task 2", false, "low", "personal", 2, 1}},
         true,
         2
      };
   ...
   "container_iteration_with_html_escaping"_test = [] {
      ...
      TodoList list{
         "HTML Test",
         {{"<script>alert('test')</script>", false, "high", "security", 1, 0}},
         true,
         1
      };
...
<div class="todo-list" data-component-id="{{component_id}}">
  ...
  {{/has_items}}
      ...
      TodoListData data{
         "htmx-todo",
         {
            {"Test HTMX", false, "testing", 1, 0, "normal", "dev", "priority-normal"}
         },
         true,
         1,
         0,
