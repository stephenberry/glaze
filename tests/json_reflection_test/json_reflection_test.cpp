...
suite meta_schema_reflection_tests = [] {
   "meta_schema_reflection"_test = [] {
      ...
      expect(
         json_schema ==
         R"({"type":["object"],"properties":{"file_name":{"$ref":"#/$defs/std::string","description":"provide a file name to load"},"is_valid":{"$ref":"#/$defs/bool","description":"for validation","default":false},"x":{"$ref":"#/$defs/int32_t","description":"x is a special integer","default":0,"minimum":1}},"additionalProperties":false,"$defs":{"bool":{"type":["boolean"]},"int32_t":{"type":["integer"],"minimum":-2147483648,"maximum":2147483647},"std::string":{"type":["string"]}},"title":"meta_schema_t"})")
         << json_schema;
   };
...
suite hash_tests = [] {
   ...
   // front_32, front_64, and three_element_unique tests moved to front_hash_test.cpp
