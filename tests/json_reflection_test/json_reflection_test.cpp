...
suite meta_schema_reflection_tests = [] {
   "meta_schema_reflection"_test = [] {
      ...
      expect(
         json_schema ==
         R"({"type":"object","properties":{"file_name":{"type":"string","description":"provide a file name to load"},"is_valid":{"type":"boolean","description":"for validation"},"x":{"type":"integer","description":"x is a special integer","minimum":1,"maximum":2147483647}},"additionalProperties":false,"title":"meta_schema_t"})")
         << json_schema;
   };
   ...
   "local_schema"_test = [] {
      ...
      expect(
         json_schema ==
         R"({"type":"object","properties":{"file_name":{"type":"string","description":"provide a file name to load"},"is_valid":{"type":"boolean","description":"for validation"},"x":{"type":"integer","description":"x is a special integer","minimum":1,"maximum":2147483647}},"additionalProperties":false,"title":"local_schema_t"})")
         << json_schema;
   };
};
