...
namespace glz::jkj
{
   namespace dragonbox
   {
      ...
      export struct ieee754_binary32
      {
      ...
      export struct ieee754_binary64
      {
      ...
      export template <class Format, class CarrierUInt, class ExponentInt = int>
      ...
      export template <class FormatTraits>
      ...
      export template <class Float, class ConversionTraits = default_float_bit_carrier_conversion_traits<Float>,
      ...
      namespace policy
      {
         namespace sign
         {
            export GLZ_JKJ_INLINE_VARIABLE struct ignore_t
            {
         ...
         namespace trailing_zero
         {
            ...
            export GLZ_JKJ_INLINE_VARIABLE struct remove_t
            {
...
#undef max
      ...
      export template <class FormatTraits, class ExponentBits, class... Policies>
