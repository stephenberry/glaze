...
namespace glz
{
   ...
   export template <class T, auto Target, auto Constraint, string_literal Message>
   ...
   export template <auto Target, auto Constraint, string_literal Message>
   constexpr auto read_constraint = read_constraint_impl<Target, Constraint, Message>();

   export template <class T, auto Constraint, string_literal Message>
   ...
   export template <auto Constraint, string_literal Message>
