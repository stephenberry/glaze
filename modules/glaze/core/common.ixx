...
namespace glz
{
   ...
   export inline std::string& string_buffer() noexcept
   {
   ...
   export inline std::string& error_buffer() noexcept
   {
      static thread_local std::string buffer(256, '\0');
      return buffer;
   }
   ...
   export struct file_include final
   {
   ...
   export template <class string_type = std::string>
   ...
   export using raw_json = basic_raw_json<std::string>;
   export using raw_json_view = basic_raw_json<std::string_view>;
   ...
   export using text = basic_text<std::string>;
   export using text_view = basic_text<std::string_view>;
    ...
    */
   export template <class Value, class Element>
...
namespace glz
{
   ...
   export template <typename T, typename Val_T, auto Opts>
