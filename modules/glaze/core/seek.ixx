...
namespace glz
{
   ...
   export template <class V, class T>
...
#pragma GCC diagnostic pop
   ...
   export template <class R, class T, class... Args>
...
namespace glz
{
   ...
   export inline constexpr std::pair<sv, sv> parent_last_json_ptrs(const sv s)
   {
   ...
   export constexpr auto json_ptrs(auto&&... args) { return std::array{sv{args}...}; }

   // must copy to allow mutation in constexpr context
   export constexpr auto sort_json_ptrs(auto arr)
   {
   ...
   export template <class Root, string_literal ptr, class Expected = void>
