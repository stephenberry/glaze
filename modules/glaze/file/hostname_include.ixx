...
namespace glz
{
   ...
   export struct hostname_include final
   {
   ...
   export inline void replace_first_braces(std::string& original, const std::string& replacement) noexcept
   {
   ...
   export inline std::string get_hostname(context& ctx)
   {
      char hostname[256]{};
