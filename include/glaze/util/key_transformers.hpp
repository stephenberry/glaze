...
namespace glz
{
   ...
   static constexpr std::string to_pascal_case(std::string_view sv) {
      std::string out;
      out.reserve(sv.size());
   ...
   static constexpr std::string to_snake_case(std::string_view sv) {
      std::string out;
   ...
   static constexpr std::string to_screaming_snake_case(std::string_view sv) {
      std::string out;
   ...
   static constexpr std::string to_kebab_case(std::string_view sv) {
      std::string out;
      out.reserve(sv.size() * 2);
   ...
   static constexpr std::string to_screaming_kebab_case(std::string_view sv) {
      std::string out;
      out.reserve(sv.size() * 2);
   ...
   static constexpr std::string to_lower_case(std::string_view sv) {
      std::string out;
      out.reserve(sv.size());
      for (char c : sv) {
         out.push_back(ascii_tolower(c));
   ...
   static constexpr std::string to_upper_case(std::string_view sv) {
      std::string out;
      out.reserve(sv.size());
      for (char c : sv) {
         out.push_back(ascii_toupper(c));
   ...
   struct screaming_snake_case {
      static constexpr std::string rename_key(const auto key) {
         return to_screaming_snake_case(key);
      }
   };
   ...
   struct screaming_kebab_case {
      static constexpr std::string rename_key(const auto key) {
         return to_screaming_kebab_case(key);
      }
   };
   
   struct lower_case {
      static constexpr std::string rename_key(const auto key) {
         return to_lower_case(key);
      }
   };
   
   struct upper_case {
      static constexpr std::string rename_key(const auto key) {
         return to_upper_case(key);
      }
   };
}