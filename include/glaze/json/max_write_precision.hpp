...
namespace glz
{
   ...
   namespace detail
   {
      ...
      struct to<JSON, write_float32_t<T>>
      {
         ...
         {
            write<JSON>::op<set_opt2<Opts, option::float_max_write_precision, fw_float_max_write_precision,
                                     float_precision::float32>()>(value.val, ctx, args...);
         }
      };
      ...
      struct to<JSON, write_float64_t<T>>
      {
         ...
         {
            write<JSON>::op<set_opt2<Opts, option::float_max_write_precision, fw_float_max_write_precision,
                                     float_precision::float64>()>(value.val, ctx, args...);
         }
      };
      ...
      struct to<JSON, write_float_full_t<T>>
      {
         ...
         {
            write<JSON>::op<set_opt2<Opts, option::float_max_write_precision, fw_float_max_write_precision,
                                     float_precision::full_precision>()>(value.val, ctx, args...);
         }
      };
